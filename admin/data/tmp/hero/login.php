...
<html lang="en-us">
  <head>
    ...
    <body class="orchid login">
      ...
      <div class="w-center">
        <div class="w-center" style='width:100%'>
        <h2 class="text-center text-primary"><?php echo $nama_aplikasi?></h2>
          <img class="demo-logo" src="../data/image/logo/ecg-logo.webp" width="100">
          <h3 class="text-center text-primary" style='margin-top:10px'>Login Admin</h3> </div>
           
        <div class="w-section" style='width:100%'>
