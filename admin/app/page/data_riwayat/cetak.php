...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_riwayat");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Riwayat </th> h-->
                ...
                <th align="center" class="th_border cell"  >Detak Jantung </th>
                <th align="center" class="th_border cell"  >Suhu Tubuh </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_riwayat where $Berdasarkan like '%$isi%'";
                ...
                $tanggal1_indo = tanggal_waktu($tanggal1);
                $tanggal2_indo = tanggal_waktu($tanggal2);
                echo '<center> Cetak Berdasarkan <b>' . $Berdasarkan . '</b> Dari Tanggal <b>' . $tanggal1_indo . '</b> s/d <b>' . $tanggal2_indo . '</b></center>';
                $querytabel = "SELECT * FROM data_riwayat where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_riwayat";
            }
